...
import org.changhong.sync.web.OAuthConnection;
import org.changhong.ui.actionbar.ActionBarPreferenceActivity;
...
//        Tomdroid.NOTES_PATH = defaultLocation;
    ...
    private void setServer(String syncServiceKey) {
        ...
        if (service == null)
            return;
        if (service.getName().equalsIgnoreCase("baidu")) auth();

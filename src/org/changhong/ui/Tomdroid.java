...
import org.changhong.Conf;
import org.changhong.Note;
import org.changhong.NoteManager;
import org.changhong.R;
import org.changhong.sync.ServiceAuth;
import org.changhong.sync.SyncManager;
import org.changhong.sync.SyncService;
import org.changhong.sync.baidu.FileUtil;
import org.changhong.ui.actionbar.ActionBarListActivity;
import org.changhong.util.*;
import org.changhong.xml.LinkInternalSpan;
import org.changhong.xml.LinkifyPhone;
import org.changhong.xml.NoteContentBuilder;
...
//		get the Path to the notes-folder from Preferences
        if (Preferences.getString(org.changhong.util.Preferences.Key.SD_LOCATION).startsWith("/")) {
        ...
        if (
              Preferences.getString(Preferences.Key.SYNC_SERVICE) == "baidu"
                ) {
            auth();
        }

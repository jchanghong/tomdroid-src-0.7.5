...
public class BDyunSyncService extends SyncService {
    ...
    // logging related
    private final static String TAG = "BDyunSyncService";

    public BDyunSyncService(Activity activity, Handler handler) {
